...
class IceboxTab extends StatefulWidget {
  @override
  _IceboxTabState createState() => _IceboxTabState();
}

class _IceboxTabState extends State<IceboxTab> {
  ...
  void _getAllTasksStatus(){
    helper.getAllTasksStatus(3).then((list){
      setState(() {
        tasks = list;
      });
    });
